...
public class PieChart {
	...
	public PieChart() {
		...
		JFreeChart chart = ChartFactory.createPieChart3D("终端流量饼图", data, true,
				false, false);
		// 设置百分比
	...
	private static DefaultPieDataset getDataSet() {
		...
		dataset.setValue("小米", 100);
		dataset.setValue("华为", 200);
		dataset.setValue("魅族", 300);
		dataset.setValue("杂牌", 400);
		return dataset;
	}
